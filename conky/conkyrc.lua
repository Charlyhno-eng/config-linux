...
I/O Read:${alignr}${color2}${diskio_read /dev/sda} ${cpubar 8,120} ${color}
I/O Write:${alignr}${color2}${diskio_write /dev/sda} ${cpubar 8,120} ${color}

256nvme:${alignr}${color2}${fs_used /mnt/256nvme}/${fs_size /mnt/256nvme} ${fs_bar 8,120 /mnt/256nvme} ${color}
I/O Read:${alignr}${color2}${diskio_read /dev/nvme0n1} ${cpubar 8,120} ${color}
I/O Write:${alignr}${color2}${diskio_write /dev/nvme0n1} ${cpubar 8,120} ${color}

Storage:${alignr}${color2}${fs_used /mnt/storage}/${fs_size /mnt/storage} ${fs_bar 8,120 /mnt/storage} ${color}
I/O Read:${alignr}${color2}${diskio_read /dev/sdb} ${cpubar 8,120} ${color}
I/O Write:${alignr}${color2}${diskio_write /dev/sdb} ${cpubar 8,120} ${color}

${color1}N E T W O R K ${hr 1} ${color}
IP Address: ${alignr}${color2}${addr wlp0s20f3} ${color}
Eth Up:${alignr}${color2}${upspeedf wlp0s20f3} ${cpubar 8,120} ${color}
Eth Down:${alignr}${color2}${downspeedf wlp0s20f3} ${cpubar 8,120} ${color}
]];
